 ...
 */
package com.frontend.msvcfrontend.Menu.MenuService;

import com.frontend.msvcfrontend.Menu.MenuEntity.Children;
import com.frontend.msvcfrontend.Menu.MenuEntity.DTOMenu;
import com.frontend.msvcfrontend.Menu.MenuEntity.Menu;
import com.frontend.msvcfrontend.MenuRepository.IRepoChildren;
import com.frontend.msvcfrontend.MenuRepository.IRepoItemMenu;
        ...
        while(roles.hasNext()){
            ...
            for (int i = 0; i < rolstr.size(); i++) {
                for (int j = 0; j < mimenu.size(); j++) {
                    ...
                    if(rolstr.get(i).equals("ROLE_FACTORY")){
                    ...
                    if(rolstr.get(i).equals("ROLE_PROPIETARIOS")){
